...
<head>
  ...
  <title>রেফারেল রিওয়ার্ড অ্যাপ</title>
...
<body>
  <div class="card">
    <h1>রেফারেল রিওয়ার্ড</h1><!-- Header Ad -->
<div class="ad-container">
  <script type="text/javascript">
    atOptions = {
      'key' : '466be42e7d3e68ab35f1c9072f620d69',
      'format' : 'iframe',
      'height' : 50,
      'width' : 320,
      'params' : {}
  ...
  <script type="text/javascript" src="//www.highperformanceformat.com/466be42e7d3e68ab35f1c9072f620d69/invoke.js"></script>
</div>

<div class="clock" id="clock">লোড হচ্ছে...</div>
  ...
  <button onclick="submitForm()">সাবমিট করুন</button>
    ...
    function submitForm() {
      ...
      if(name && address && phone) {
        ...
        alert("ফর্ম সফলভাবে জমা হয়েছে! আমাদের টিম শীঘ্রই আপনার সাথে যোগাযোগ করবে।");
      } else {
        alert("অনুগ্রহ করে সব ঘর পূরণ করুন!");
      }
    }
  </script></body>
</html># sharing-you-friend-
